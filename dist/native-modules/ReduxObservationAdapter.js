...
export var ReduxObservationAdapter = (function () {
    ...
    ReduxObservationAdapter.prototype.getObserver = function (object, propertyName, descriptor) {
        var isReduxSelector = (descriptor && descriptor.get && descriptor.get.__redux__) || metadata.get(SELECTOR_METADATA_KEY, object, propertyName);
        if (isReduxSelector) {
