System.register(['aurelia-metadata', './utils', './Store'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var aurelia_metadata_1, utils_1, Store_1;
    var SELECTOR_METADATA_KEY;
    /**
    ...
    function select(selector, config) {
        ...
        return function (target, propertyKey) {
            ...
            aurelia_metadata_1.metadata.define(SELECTOR_METADATA_KEY, true, target, propertyKey);
    ...
    return {
        ...
        execute: function() {
            exports_1("SELECTOR_METADATA_KEY", SELECTOR_METADATA_KEY = 'aurelia-redux:selector');
        }
    }
});
